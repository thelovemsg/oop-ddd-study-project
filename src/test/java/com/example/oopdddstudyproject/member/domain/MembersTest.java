...
class MembersTest {
    ...
    void Members_생성() {
        ...
        // when
        Members members = Members.from(membersCreate, timeGenerator);
    ...
    void Members_수정() {
        ...
        // when
        Members updated = original.updateMember(membersUpdate, new FakeTimeGenerator(9999L));
